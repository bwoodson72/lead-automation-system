...
export const button = tv({
  ...
  variants: {
    variant: {
      ...
      outline: "dark:border-input focus-visible:ring-outline/50 bg-background text-foreground dark:bg-input/30 focus-visible:border-outline hover:bg-muted dark:hover:bg-input/50 border shadow-xs",
