...
const products = defineCollection({
  ...
  schema: ({ image }) => z.object({
    ...
    status,
    family: z.string(),
    path: z.enum(["services", "saas", "both"]),
    audience: z.string(),
    ...
    pageCopy: z.object({
      motivationEyebrow: z.string().optional(),
      motivationTitle: z.string().optional(),
      problemEyebrow: z.string().optional(),
      problemTitle: z.string().optional(),
      desiredEyebrow: z.string().optional(),
      desiredTitle: z.string().optional(),
      contentsEyebrow: z.string().optional(),
      contentsTitle: z.string().optional(),
      fitForEyebrow: z.string().optional(),
      fitNotForEyebrow: z.string().optional(),
    ...
    whoItsNotFor: z.array(z.string()).min(1),
...
const bundles = defineCollection({
  ...
  schema: z.object({
    ...
    pageCopy: z.object({
      ...
      implementationEyebrow: z.string().optional(),
